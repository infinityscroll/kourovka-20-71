...
contains no \texttt{sorry}, \texttt{admit}, added axiom, or unsafe declaration,
is provided in the repository together with scripts reproducing every claim.
Its finite exhaustive decisions use \texttt{native\_decide}, and hence trust
...
Exploratory sweeps beyond order $11$ also found no example in the tested
connected slices: regular graphs of orders $12$--$14$ with
$2 \le d \le (n-1)/2$ (the largest slice has $21{,}609{,}300$ connected
$6$-regular graphs of order $14$), and graphs of orders $12$--$13$ whose
degrees lie in $\{a,a+1\}$ for $2 \le a \le 5$ ($15{,}409{,}504$ and
$836{,}922{,}152$ graphs respectively). These slices are not exhaustive:
although card types and orbit counts are complement-invariant,
complementation need not preserve connectivity. Full data are in the
repository, and no exhaustive claim beyond order $11$ is made.
