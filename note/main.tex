...
$k = 3$ must have at least $13$ vertices.
\end{abstract}
...
any $k \in \{2,3,4\}$;
\item no graph of order at most $12$ has $k \in \{2,3\}$ card types and
more than $k$ orbits. Consequently any affirmative example for the two
remaining cases of Problem~\ref{prob} has at least $13$ vertices.
\end{enumerate}
\end{proposition}
...
The census was completed at order $12$: all $164{,}059{,}830{,}476$
connected graphs (again matching OEIS A001349 exactly) were generated, of
which $1{,}905{,}839{,}762$ passed the degree filter and $32{,}500$ required
canonical labelling; none is an example for $k \in \{2,3\}$. Beyond order
$12$, structured sweeps also found no example: all regular graphs of orders
$13$--$14$ and all graphs of order $13$ whose degrees lie in a window
$\{a, a+1\}$, $2 \le a \le 5$ ($836{,}922{,}152$ graphs). Here degrees
$d \le (n-1)/2$ (resp.\ the low windows) suffice: card types and orbit
counts are complement-invariant, and although complementation need not
preserve connectivity, the complement of a disconnected graph is always
connected, so the high slices are covered by additionally testing the
$2{,}844$ disjoint unions of low-slice connected components --- none of
which is an example either. Full data are in the repository.
