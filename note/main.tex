...
Structured sweeps beyond order $11$ (regular graphs of degree
$d \le (n-1)/2$, which suffices since card types and orbits are invariant
under complementation, and near-regular degree windows) are reported in the
repository.
